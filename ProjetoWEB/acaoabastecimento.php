...
function alterar($codigo)
{
    ...
    echo $vet, " ", $sql;
    if ($result == 1)
        header('location:cadabastecimento.php?msg="sa"&acao=editar&id_abastecimento=' . $codigo);
    else
        header('location:cadabastecimento.php?msg="er"&acao=editar&id_abastecimento=' . $codigo);
