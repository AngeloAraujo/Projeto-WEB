...
<form action="acaomodelo.php" method="post">
   ...
   <div class="modal-body">
    ...
    <input class="form-control" required=true   type="text" name="descricao" id="descricao" value="<?php if ($acao == "editar") echo $dados['descricao']; ?>"><br>
    </div>   
    <div class="form-group">  Consumo do veiculo Km/Litros:
    <input class="form-control" required=true   type="text" name="consumo" id="consumo" value="<?php if ($acao == "editar") echo $dados['consumo']; ?>"><br>
    </div>
    <div class="form-group"> Tamanho do tanque de combustível do modelo
    <input class="form-control" required=true   type="text" name="tanque" id="tanque" value="<?php if ($acao == "editar") echo $dados['tanque']; ?>"><br>
    </div>
    <div class="modal-footer">
    <button class="btn btn-outline-success" type="submit" name="acao" id="acao" value="salvar">Salvar Modelo</button>  
    <a href="listarmodelo.php"><button class="btn btn-outline-primary">Listar</button></a>   
</div>
</div>    
</div>    
</div>    
