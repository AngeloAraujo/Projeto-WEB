        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Adicionar Motorista</h5></div>
   <div class="modal-body">
             <div class="form-group">       Código:
    <input class="form-control" readonly  type="number" name="id_motorista" id="id_motorista" value="<?php if ($acao == "editar") echo $dados['id_motorista']; else echo 0; ?>"><br>
    </div>
